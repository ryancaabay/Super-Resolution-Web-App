...
class ResidualBlock(Module):
    def __init__(self):
        ...
        self.bn2 = BatchNorm2d(
            num_features=64, act=None, gamma_init=G_init, data_format="channels_first"
        )
...
class SRGAN_g(Module):
    ...
    def __init__(self):
        ...
        self.subpiexlconv1 = SubpixelConv2d(
            data_format="channels_first", scale=2, act=tlx.ReLU
        )
        self.conv4 = Conv2d(
            out_channels=256,
            kernel_size=(3, 3),
        ...
        self.subpiexlconv2 = SubpixelConv2d(
            data_format="channels_first", scale=2, act=tlx.ReLU
        )
        self.conv5 = Conv2d(
            3,
...
class SRGAN_g2(Module):
    ...
    def __init__(self):
        ...
        self.bn1 = BatchNorm2d(
            act=None, gamma_init=G_init, data_format="channels_first"
        )
        self.upsample1 = UpSampling2d(
            data_format="channels_first", scale=(2, 2), method="bilinear"
        )
        self.conv3 = Conv2d(
            out_channels=64,
            kernel_size=(3, 3),
        ...
        self.bn2 = BatchNorm2d(
            act=tlx.ReLU, gamma_init=G_init, data_format="channels_first"
        )
        self.upsample2 = UpSampling2d(
            data_format="channels_first", scale=(4, 4), method="bilinear"
        )
        self.conv4 = Conv2d(
            out_channels=32,
            kernel_size=(3, 3),
...
class SRGAN_d2(Module):
    ...
    def __init__(
        ...
        self.conv1 = Conv2d(
            ...
            kernel_size=(3, 3),
            stride=(1, 1),
            act=tlx.LeakyReLU(negative_slope=0.2),
            padding="SAME",
            W_init=W_init,
            data_format="channels_first",
        )
...
class SRGAN_d(Module):
    def __init__(self, dim=64):
        ...
        self.bn10 = BatchNorm2d(
            num_features=dim * 8, gamma_init=G_init, data_format="channels_first"
        )
